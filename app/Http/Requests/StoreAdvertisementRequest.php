...
class StoreAdvertisementRequest extends FormRequest {
    ...
    public function rules (): array {
        return [
            ...
            // Characteristics
            'vehicle_body_id' => 'nullable|exists:vehicle_bodies,id' ,
            'color_id' => 'nullable|exists:colors,id' ,
            'vehicle_category' => 'nullable|string|max:255' ,
            'mileage' => 'nullable|integer' ,
            'registration_month' => 'nullable|string|max:2' ,
            ...
            'motor_power_kw' => 'nullable|integer' ,
            'motor_power_cv' => 'nullable|integer' ,
            ...
            // Environment
            'fuel_type_id' => 'nullable|string|max:50' ,
