    ...
    <div class="upper-box">
        <div class="boxcar-container">
            <div class="row wow fadeInUp">
                ...
                <li><span>{{ __('messages.about_us') }}</span></li>
                        </ul>
                        <h2>{{ __('messages.about_us') }}</h2>
                        <div class="text">{{ $aboutSections->where('section', 'mission')->first()?->localized_title ?? __('messages.we_value_clients') }}</div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="content-box">
                        @foreach($aboutSections as $section)
                            <div class="text">{{ $section->localized_content }}</div>
                        @endforeach
                    </div>
                </div>
            </div>
                ...
                @foreach($popularBrands->take(6) as $index => $brand)
                    ...
                    <div class="cars-block col-lg-2 col-md-6 col-sm-6">
                        <div class="inner-box wow fadeInUp" data-wow-delay="{{ $index * 100 }}ms">
                            ...
                            <div class="content-box">
                                <h6 class="title">
                                    <a href="{{ route('inventory.list', ['brand' => $brand->id]) }}">{{ $brand->localized_name }}</a>
                                </h6>
                            </div>
                        </div>
                    </div>
        ...
        <div class="faq-column wow fadeInUp" data-wow-delay="400ms">
            <div class="inner-column">
                <div class="boxcar-title text-center">
                    <h2 class="title">{{ __('messages.faqs') }}</h2>
                </div>
