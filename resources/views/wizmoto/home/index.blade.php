                        ...
                        <div class="form-tab-content wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <div class="form-tab-pane" id="tab-2">
                                <form>
                                    ...
                                    <div class="form-submit">
                                        <button type="submit" class="theme-btn">Search 9451 Rides</button>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="image-box">
                                    <div class="slider-thumb">
                                        @foreach ($newAdvertisement->getMedia('covers')->take(3) as $image)
                                            <div class="image">
                                                <a href="{{ $image->getUrl() }}" data-fancybox="gallery-{{ $newAdvertisement->id }}">
                                                    <img src="{{ $image->getUrl() }}" alt="{{ $newAdvertisement->title ?? 'Advertisement Image' }}">
                                                </a>
                                            </div>
                                        @endforeach
                                    </div>
