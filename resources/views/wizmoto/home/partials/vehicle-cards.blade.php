    ...
    <div class="inner-box">
        ...
        <div class="right-box">
            <div class="content-box">
                ...
                <div class="inspection-sec">
                    ...
                    <div class="inspection-box">
                        ...
                        <div class="info">
                            <span>Fuel Type</span>
                            <small>{{ $advertisement->fuelType?->name ?? 'N/A' }}</small>
                        </div>
                    </div>
                    <div class="inspection-box">
                        <span class="icon">
            ...
            <div class="content-box-two">
                ...
                <a href="{{ route('advertisements.show', $advertisement->id) }}" class="button">View Details<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                @if($advertisements->currentPage() < $advertisements->lastPage() - 2)
                    ...
                    @endif
                    <li class="page-item">
                        <a class="page-link" href="{{ $advertisements->url($advertisements->lastPage()) }}">{{ $advertisements->lastPage() }}</a>
                    </li>
                @endif
            ...
            <div class="pagination-info">
                <div class="text">Showing {{ $advertisements->firstItem() ?? 0 }} to {{ $advertisements->lastItem() ?? 0 }} of {{ $advertisements->total() ?? 0 }} vehicles</div>
                <div class="page-info">Page {{ $advertisements->currentPage() }} of {{ $advertisements->lastPage() }}</div>
            </div>
        </nav>
    </div>
@endif