            ...
            <div class="boxcar-container">
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
                        <div class="inner-column">
                            ...
                            <div class="location-box">
                                ...
                                <a target="_blank" href="https://www.google.com/maps/search/?api=1&query={{ urlencode($provider->address . ' ' . $provider->city . ' ' . $provider->zip_code) }}" class="brand-btn">Get Directions
                    ...
                    <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
                        <div class="side-bar">
                            <a href="#" class="message">Send Message
                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewbox="0 0 15 14" fill="none">
                                    <g clip-path="url(#clip0_881_16253)">
                                        <path d="M14.1111 0H5.55558C5.34062 0 5.16668 0.173943 5.16668 0.388901C5.16668 0.603859 5.34062 0.777802 5.55558 0.777802H13.1723L0.613941 13.3362C0.46202 13.4881 0.46202 13.7342 0.613941 13.8861C0.689884 13.962 0.789415 14 0.88891 14C0.988405 14 1.0879 13.962 1.16388 13.8861L13.7222 1.3277V8.94447C13.7222 9.15943 13.8962 9.33337 14.1111 9.33337C14.3261 9.33337 14.5 9.15943 14.5 8.94447V0.388901C14.5 0.173943 14.3261 0 14.1111 0Z" fill="white"></path>
                                    </g>
                                    <defs>
                        ...
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            <div class="row car-slider-three" data-preview="4">
                                @foreach($advertisements as $advertisement)
                                    ...
                                    @endphp
                                        <!-- car-block-four -->
                                    <div class="car-block-three col-lg-3 col-md-6 col-sm-12 slick-slide slick-current slick-active">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                <figure class="image">
