                ...
                <div class="form-sec">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="false">Forgotten password</button>
                        </div>
                    </nav>
                            ...
                            <div class="form-box">
                                <form method="POST" action="{{ route('provider.password.email') }}">
                                    ...
                                    <div class="form-submit">
                                        <button type="submit" class="theme-btn">Send Reset Link <img src="images/arrow.svg" alt="">
                                        </button>
                                    </div>
                                </form>
                            </div>
