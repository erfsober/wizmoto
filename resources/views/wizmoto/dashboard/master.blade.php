...
<section class="dashboard-widget">
    <div class="right-box">
        <div class="side-bar">
            <ul class="nav-list">
                <li><a href="{{route('dashboard.my-advertisements')}}"><img src="{{asset("wizmoto/images/icons/dash2.svg")}}" alt="">My Listings</a></li>
                <li><a href="{{route('dashboard.create-advertisement')}}"><img src="{{asset("wizmoto/images/icons/dash3.svg")}}" alt="">Add Listings</a></li>
                <li><a href="{{route('dashboard.profile')}}"><img src="{{asset("wizmoto/images/icons/dash7.svg")}}" alt="">My Profile</a></li>
                <li>
                    <a href="{{ route('provider.logout') }}"
                       onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
